...
public class MapController implements Renderer {
    ...
    public boolean longitudeLatitudeToScreenPosition(LngLat position, float[] screenPosition) {
        return nativeLongitudeLatitudeToScreenPosition(mapPointer, position.longitude, position.latitude, screenPosition);
    }
    ...
    private synchronized native boolean nativeLongitudeLatitudeToScreenPosition(long mapPtr, double lon, double lat, float[] screenCoords);
